...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[32px] gap-6">
      <h1 className='text-3xl font-bold text-gray-800'>FundRaising Dapp</h1>

      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#f9ebeb] rounded-[100px]">
      ...
      {/* Small screen navigation */}
        ...
        <div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            ...
            <div>
            <img src="https://1000logos.net/wp-content/uploads/2021/05/GitHub-logo.png" alt="user" className="w-[60%] h-[60%] object-contain" />
            </div>
          <img 
            src={menu}
            alt="menu"
