  ...
  const handleSubmit = async (e) => {
    ...
    checkIfImage(form.image, async (exists) => {
      if(exists) {
        ...
        setIsLoading(false);
        toast.success("Campaign Created It may take up to 30 seconds to confirm")
        navigate('/');
      } else {
  ...
  return (
    <div className="bg-gray-100 flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      ...
      <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
        ...
        <div className="w-full flex justify-start items-center p-4 bg-[#202e68] h-[120px] rounded-[10px]">
          <img src={money} alt="money" className="w-[40px] h-[40px] object-contain"/>
          <h4 className="font-epilogue font-bold text-[25px] text-gray-200 ml-[20px]">You will get 100% of the raised amount</h4>
        </div>
